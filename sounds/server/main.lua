...
------
RegisterServerEvent('InteractSound_SV:PlayOnOneD')
AddEventHandler('InteractSound_SV:PlayOnOneD', function(clientNetId, soundFile, soundVolume)
...
------
RegisterServerEvent('InteractSound_SV:PlayOnSourceD')
AddEventHandler('InteractSound_SV:PlayOnSourceD', function(soundFile, soundVolume)
...
------
RegisterServerEvent('InteractSound_SV:PlayOnAllD')
AddEventHandler('InteractSound_SV:PlayOnAllD', function(soundFile, soundVolume)
...
------
RegisterServerEvent('InteractSound_SV:PlayWithinDistanceD')
AddEventHandler('InteractSound_SV:PlayWithinDistanceD', function(maxDistance, soundFile, soundVolume)
